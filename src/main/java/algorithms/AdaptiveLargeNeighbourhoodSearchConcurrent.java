            ...
            */
                ...
                if (feasible) {
                    ...
                    if (deltaE < 0) {
                        ...
                        if (currCost < bestCost.get()) {
                            bestSolution.set(currSolution);
                            bestCost.set(currCost);
                        }
                    } else if (random.nextDouble() < pow(E, -deltaE / finalT)) {
                        currSolution = newSolution;
                        currCost = newCost;
                ...
                updateOperator(operator, newSolutionFound, feasible, newCost, currCost, bestCost.get());
